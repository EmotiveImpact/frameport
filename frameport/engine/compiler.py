...
def generate(ir, root: Path):
    ...
    write(react_dir/"package.json",json.dumps(dict(name="frameport-export",version="1.0.0",private=True,type="module",scripts={"dev":"vite","build":"tsc --noEmit && vite build","preview":"vite preview"},dependencies={"react":"19.1.1","react-dom":"19.1.1"},devDependencies={"@types/react":"19.1.10","@types/react-dom":"19.1.9","typescript":"5.9.3","vite":"6.4.3"}),indent=2))
